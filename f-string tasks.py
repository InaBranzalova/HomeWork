...
### Your code here
print(f'Hell, my name is {name}, I am {age} years old, and my favorite color is {color}.')
...
### Your code here
print(f'{item1_name:<30} {item1_price:>30}')
print(f'{item2_name:<30} {item2_price:>30}')
print(f'{item3_name:<30} {item3_price:>30}')
...
### Your code here
alice_place = round(((3*60)+minutes)/distance_km,2)
print(f'Alice\'s place : {alice_place} minutes/km')
total_time = 3 + (minutes/60)
